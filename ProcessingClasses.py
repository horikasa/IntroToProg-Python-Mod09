...
# HOrikasa,12.13.2021, Added blank line logic
# ---------------------------------------------------------- #
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str):
        ...
        try:
            ...
            for line in file:
                line = line.strip()  # added this code to omit blank lines that EmployeeData.txt came with
                if line == '':       # code also removes blank line when data is saved
                    continue
                row = line.split(",")
